...
echo -e "\e[33mkitty (terminal):\e[0m \e[4mhttps://sw.kovidgoyal.net/kitty/binary/\e[0m (make sure kitty is in your PATH!)"
...
cp ${dir}/starship.toml ${dst}/
cp ${dir}/hyfetch.json ${dst}/
cp ${dir}/wallpaper.jpg ${dst}/

mkdir -p ${dst}/scripts
cp ${dir}/scripts/media.sh ${dst}/scripts/
cp ${dir}/scripts/volume.sh ${dst}/scripts/
